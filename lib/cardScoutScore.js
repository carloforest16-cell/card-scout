 ...
 *
 *  Vérification : 0.14 + 0.10 + 0.10 + 0.10 + 0.04 + 0.14 + 0.07 + 0.08 + 0.06 + 0.05 + 0.05 + 0.03 + 0.04 = 1.00
 */
export const FACTOR_WEIGHTS = {
  ...
  // Buzz Wikipedia (vues 7j) — activé 2026-06-20
  socialAttention: 0.03,
  // Contexte d'équipe (standings + marché géographique) — activé 2026-06-21
  teamContext: 0.04,
};
