...
function scoreCachePath(playerId) {
  // v6_4 = retrait SportsCardsPro : facteur Marché de nouveau sur la médiane eBay
  //        seule (plus de prix vendu SCP) → invalide v6_3
  return `scores/ai-score-v6_4-${playerId}.json`;
}
