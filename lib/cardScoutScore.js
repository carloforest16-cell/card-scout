...
function scoreCachePath(playerId) {
  // v6_1 = Marché en courbe bornée sur médiane (abandon dealGap biaisé) → invalide v6
  return `scores/ai-score-v6_1-${playerId}.json`;
}
...
function scoreMarketValue(ebayMedianPriceCad, dealGapPct = null) {
  // v6.1 — courbe équilibrée et BORNÉE sur la médiane. Récompense un marché de
