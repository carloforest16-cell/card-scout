...
const SEARCH_QUALIFIER_RE =
  /\b(?:auto|autograph|young\s+guns?|ygr?|rookie|rc|psa|bgs|sgc|cgc|graded?|grad(?:é|e)e?|parallel|parall[èe]le|canvas|gold|silver|black|patch|jersey|relic|opc|o-pee-chee|sp|ud|upper\s+deck|clear\s+cut|allure|the\s+cup|spx|premier|allstar|all-star|numbered|num[ée]rot[ée])\b/i;
