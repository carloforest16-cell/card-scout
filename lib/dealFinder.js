...
const TITLE_EXCLUDE_NON_CARD_RE =
  /\b(?:Poster|Photo|8x10|11x17|Canvas\s+Print|Framed|Plaque|Bobblehead|Figurine|Magazine|Sticker|Decal|Puck|Pennant|Giveaways?|Arena\s+Giveaway|Stadium\s+Giveaway|Checklist)\b|\bPrint\b(?!ing)(?!\s+Run)/i;
