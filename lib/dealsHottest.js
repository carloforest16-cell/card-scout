...
const BLOB_CACHE_PATHNAMES = {
  raw: "hottest-deals-raw-cache-v4.json",
  graded: "hottest-deals-graded-cache-v4.json",
};
...
async function resolveCardScoutScoreForPlayer(player) {
  ...
  // Agrégat sur 30 joueurs → score mathématique (pas d'appel Claude par joueur,
  // sinon le rebuild dépasse maxDuration et la section reste vide).
