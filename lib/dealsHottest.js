...
async function buildHottestDealsFresh(cardMode = "raw") {
  ...
  // Tri par investmentScore décroissant — ce que l'utilisateur voit sur la
  // carte doit être aussi le rang. L'ancien tri hybride (60/40 avec le CM)
  // faisait remonter du 6.7 au-dessus du 7.2 quand le joueur avait un plus
  // gros CM (visuel incohérent, signalé par Carlo 2026-07-18). La qualité du
  // joueur est déjà assurée en amont : pool restreint à ELITE_PLAYER_IDS.
