...
{
  "investmentScore": (0-10, précis à 0.1),
  "playerAnalysis": {
    "ageScore": (0-10),
  ...
  return normalizeAnalysis(
    {
      ...
      playerAnalysis: {
        ...
        contractScore: 6,
        contractComment: "Situation contractuelle à surveiller selon l'actualité NHL.",
        marketScore: 7,
      ...
      risks: [
        "Blessure ou ralentissement de production peut compresser les prix à court terme.",
      ],
