...
export const PACK_BOX_RE =
  /\b(?:Fat\s*Pack|Retail\s*Pack|Blaster|Hobby\s*(?:Box|Pack)|Mega\s*Box|Factory\s*(?:Set|Sealed)|Sealed\s*(?:Pack|Box|Case)|Card\s+(?:Pack|Lot))\b|\b\d+\s*cards\b|\b(?:Box|Case|Group)\s+Break\b|\bTin\b|^\s*\(\d+\)/i;
