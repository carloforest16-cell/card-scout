...
/**
 * Sous-ensemble « élite » utilisé UNIQUEMENT par la vitrine Hottest Deals — des
 * noms que tout collectionneur reconnaît immédiatement. Objectif : que la page
 * /deals ouvre sur du McDavid / Caufield / Celebrini / Bedard, pas sur des
 * prospects obscurs comme Jiri Kulich ou Corson Ceulemans. Le reste du site
 * (recherche directe, opportunités, pulse) continue d'utiliser TRENDING_PLAYER_IDS.
 */
// ⚠️ Les IDs de TRENDING_PLAYER_IDS ci-dessus sont pour la plupart MAL ÉTIQUETÉS
// (commentaires ne correspondent pas aux vrais joueurs — vérifié via l'API NHL
// le 2026-07-18 : 8479325 = McAvoy pas Brady Tkachuk, 8480785 = Josh Dickinson
// pas Stützle, etc.). Cette liste ELITE a été reconstruite en cherchant chaque
// joueur par nom via l'API NHL — IDs vérifiés un par un.
export const ELITE_PLAYER_IDS = [
  // Superstars NHL
  8478402, // Connor McDavid — EDM
  8471675, // Sidney Crosby — PIT
  8477492, // Nathan MacKinnon — COL
  8477934, // Leon Draisaitl — EDM
  8479318, // Auston Matthews — TOR
  8477956, // David Pastrnak — BOS
  8476453, // Nikita Kucherov — TBL
  8478550, // Artemi Panarin — NYR
  8477493, // Aleksander Barkov — FLA
  8480069, // Cale Makar — COL
  8480800, // Quinn Hughes
  8478420, // Mikko Rantanen — DAL
  8479314, // Matthew Tkachuk — FLA
  // Franchise / stars
  8480801, // Brady Tkachuk — OTT
  8481559, // Jack Hughes — NJD
  8477933, // Sam Reinhart — FLA
  8480018, // Nick Suzuki — MTL
  8478483, // Mitch Marner — VGK
  8478010, // Brayden Point — TBL
  8480027, // Jason Robertson — DAL
  8480002, // Nico Hischier — NJD
  8478398, // Kyle Connor — WPG
  8479420, // Tage Thompson — BUF
  8480036, // Miro Heiskanen — DAL
  8474600, // Roman Josi — NSH
  // Top jeunes stars + prospects « must-know »
  8484144, // Connor Bedard — CHI
  8481540, // Cole Caufield — MTL
  8484801, // Macklin Celebrini — SJS
  8483515, // Juraj Slafkovský — MTL
  8483457, // Lane Hutson — MTL
  8484984, // Ivan Demidov — MTL
  8484387, // Matvei Michkov — PHI
  8482116, // Tim Stützle — OTT
  8484153, // Leo Carlsson — ANA
  8482740, // Wyatt Johnston — DAL
  8484166, // Adam Fantilli — CBJ
  8482124, // Quinton Byfield — LAK
  8483524, // Shane Wright — SEA
  8482699, // Dylan Guenther — UTA
  8482684, // Luke Hughes — NJD
  8482671, // Owen Power — BUF
];
